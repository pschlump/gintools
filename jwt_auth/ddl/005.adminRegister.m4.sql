...
create or replace function q_auth_v1_register_role ( p_email varchar, p_pw varchar, p_hmac_password varchar, p_first_name varchar, p_last_name varchar, p_userdata_password varchar, p_secret varchar, p_registration_token varchar, p_role_to_use varchar )
	returns text
	as $$
DECLARE
	l_data					text;
