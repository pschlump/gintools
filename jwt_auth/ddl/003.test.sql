...
BEGIN
	...
	if l_cnt = 0 then
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 1 - failed to create a user File:003.test.m4.sql Line No:98' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 1 - failed to create a user File:003.test.m4.sql Line No:99' );
	else
	...
	if l_status != '"success"' then
		...
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 2 - login when should not File:003.test.m4.sql Line No:121' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 2 - login when should not File:003.test.m4.sql Line No:122' );
	end if;
	...
	select l_text::jsonb -> 'status' into l_status;
	if l_status != '"success"' then
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 3 - validation of email File:003.test.m4.sql Line No:137' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 3 - validation of email File:003.test.m4.sql Line No:138' );
	else
	...
	select l_text::jsonb -> 'status' into l_status;
	if l_status != '"success"' then
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 3 - validation of email File:003.test.m4.sql Line No:151' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 3 - validation of email File:003.test.m4.sql Line No:152' );
	else
	...
	if l_status != '"success"' then
		...
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 5 - faile to login - bad password File:003.test.m4.sql Line No:172' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 5 - faile to login - bad password File:003.test.m4.sql Line No:173' );
	end if;
	...
	if l_status != '"success"' then
		...
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 5 - faile to login - bad username File:003.test.m4.sql Line No:184' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 5 - faile to login - bad username File:003.test.m4.sql Line No:185' );
	end if;
	...
	select l_text::jsonb -> 'status' into l_status;
	if l_status != '"success"' then
		insert into t_output ( msg ) values ( 'FAILED - registraiton test 5 - faile to login File:003.test.m4.sql Line No:198' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - registraiton test 5 - faile to login File:003.test.m4.sql Line No:199' );
	else
...
BEGIN
	...
	if l_bool then
		insert into t_output ( msg ) values ( 'FAILED - q_admin_HasPriv test 1 File:003.test.m4.sql Line No:246' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - q_admin_HasPriv test 1 File:003.test.m4.sql Line No:247' );
	else
	...
	if l_bool then
		...
		insert into t_output ( msg ) values ( 'FAILED - q_admin_HasPriv test 2 File:003.test.m4.sql Line No:260' );
		insert into x_tmp_pass_fail ( name ) values ( 'FAILED - q_admin_HasPriv test 2 File:003.test.m4.sql Line No:261' );
	end if;
...
BEGIN
	...
	if l_cnt1 = 0 then
		insert into t_output ( msg ) values ( 'Test Failed: File:003.test.m4.sql Line No:327 -- missing data in q_qr_role' );
		l_fail = true;
		n_err = n_err + 1;
	end if;
	...
	if l_cnt1 = 0 then
		insert into t_output ( msg ) values ( 'Test Failed: File:003.test.m4.sql Line No:334 -- missing data in q_qr_priv' );
		l_fail = true;
		n_err = n_err + 1;
	end if;
	...
	if l_cnt1 = 0 then
		insert into t_output ( msg ) values ( 'Test Failed: File:003.test.m4.sql Line No:341 -- missing data in q_qr_role_priv' );
		l_fail = true;
		n_err = n_err + 1;
	end if;
	...
	if l_cnt1 = 0 then
		insert into t_output ( msg ) values ( 'Test Failed: File:003.test.m4.sql Line No:348 -- missing data in q_qr_user_role' );
		l_fail = true;
		n_err = n_err + 1;
	end if;
